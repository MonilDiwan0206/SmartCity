package com.example.monildiwan.smartcity;
                    ...
                    mAuth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(!task.isSuccessful()){
                                Toast.makeText(LoginActivity.this, "Incorrect User Details", Toast.LENGTH_LONG).show();
                            } else {
                                Intent gintent = new Intent(LoginActivity.this,GActivity.class);
